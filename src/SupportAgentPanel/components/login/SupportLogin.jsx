...
const SupportLogin = (props) => {
  ...
  const supportAgentLogIn = async () => {
    try {
      let url =
        "https://video-agent-flyweis.herokuapp.com/support-agents/login";
      let temp = {
        email: email,
        password: password,
      };
          ...
          <div className="main_padding_top_bottom">
            ...
            <div className="inputfiledformatting mt-2">
              <Button
                ...
                onClick={supportAgentLogIn}
              >
                Log in Support Agent
              </Button>
              <div
                style={{
                  margin: "20px 0",
            ...
            <div
              ...
              onClick={() => navigate("/supportAgent/forgot")}
            >
              Forgot Password?
            </div>
