...
const VideoLogin = (props) => {
  ...
  const videoAgentLogIn = async () => {
    try {
      let url = "https://video-agent-flyweis.herokuapp.com/video-agents/login";
      let temp = {
        email: email,
        password: password,
      };
        ...
        <Card className="pt-2 pb-2 Card_shadow form_width mt-2">
          ...
          <div className="main_padding_top_bottom">
            ...
            <div
              ...
              onClick={() => navigate("/videoAgent/forgot")}
            >
              Forgot Password?
            </div>
