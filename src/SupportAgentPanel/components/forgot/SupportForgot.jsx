  ...
  const supportForgotPass = async () => {
    ...
    try {
      const res = await axios.post(
        "https://video-agent-flyweis.herokuapp.com/support-agents/forgot-password",
        temp,
        config
      );
      console.log(res);
      alert("Otp Sent Successfully");
      navigate("/supportAgent/reset");
    } catch (e) {
