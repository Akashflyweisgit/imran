  ...
  const supportResetPass = async () => {
    ...
    try {
      const res = await axios.post(
        "https://video-agent-flyweis.herokuapp.com/support-agents/reset-password",
        temp,
        config
      );
      console.log(res);
      alert("Password Reset Successfully");
      navigate("/supportAgent/login");
    } catch (e) {
...
export default SupportResetPass;
